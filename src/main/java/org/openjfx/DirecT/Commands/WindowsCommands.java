...
public class WindowsCommands {
	...
	private static String hotspotName="";
	private static String hotspotPassword="";
				...
				return new Task<Void>() {
					...
					protected Void call() throws Exception {
						...
						try {
							...
							if(hotspotName.equals("")&&hotspotPassword.equals("")) {
								hotspotName = DetailsJsonHandler.getName() + "_DrT";
							...
							c = c.replace("test", hotspotName);
							c = c.replace("12345678", hotspotPassword);
